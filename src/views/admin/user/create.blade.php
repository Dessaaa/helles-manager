  ...
  <div class="col-lg-12">
    <div class="box">
      <div class="box-header">
        <h2><i class="fa fa-plus"></i><span class="break"></span>Incluir</h2>
        <!-- <div class="box-icon">
      ...
      <div class="box-content">
        {{ Form::model($user, array('route' => 'admin.user.store', 'class' => 'form-horizontal', 'enctype' => 'multipart/form-data')) }}
        <fieldset>  
